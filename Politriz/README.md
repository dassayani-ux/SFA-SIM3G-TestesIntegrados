Pasta utilizada para armazenar os casos de testes automatizados da **Politriz**.
...
1. Criar um arquivo chamado **globalVariables.robot** no direório: **Politriz/resources/variables/web/global**.
...
2. Criar um arquivo chamado **loginVariables.robot** no direório: **Politriz/resources/variables/web/login**.
