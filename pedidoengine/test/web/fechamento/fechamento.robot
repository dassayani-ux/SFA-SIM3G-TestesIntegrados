...
...    Conecta ao banco de dados    AND
...    Configura wsconfigpedido no banco    AND
...    Prepara dados de automacao para listagem    AND
...    Configura padrao cabecalho pedido    AND
...    Configura padrao filtros pedido    AND
...    Habilita finalizar pedido na listagem    AND
...    Abre Navegador
...
## 
##     ${idAntes}=    Retornar ultimo atendimento
##     Acessar tela de lançamento de atendimento
##     Preencher cabeçalho do atendimento
##     Iniciar atendimento
##     Incluir imagem no atendimento
##     Gravar atendimento
##     ${idAtendimento}=    Retornar ultimo atendimento
##     BuiltIn.Should Be True    ${idAtendimento} > ${idAntes}
##     ...    msg=Nenhum novo atendimento foi criado (último antes: ${idAntes}, depois: ${idAtendimento})
##     BuiltIn.Log To Console    Atendimento ${idAtendimento} criado com sucesso!
## 
